(function($angular) {
    ...
    $angular.module('myApp_ED', ['ngDroplet']).controller('IndexController', function IndexController($scope, $timeout) {
        ...
        $scope.$on('$dropletReady', function whenDropletReady() {   
            ...
            $scope.interface.setRequestUrl('http://localhost:3000/upload');
