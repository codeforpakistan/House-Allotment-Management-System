var App = function () {
    ...
    var handleCalendar = function () {
        ...
        var initDrag = function (el) {
            ...
            var eventObject = {
                title: jQuery.trim(el.text()) // use the element's text as the event title
            };
        ...
        var addEvent = function (title, priority) {
            ...
            var html = jQuery('<div data-class="label label-' + priority + '" class="external-event label label-' + priority + '">' + title + '</div>');
        ...
        jQuery('#event_add').click(function () {
            var title = jQuery('#event_title').val();
            var priority = jQuery('#event_priority').val();
    ...
    var handleChat = function () {
        var cont = jQuery('#chats');
        var list = jQuery('.chats', cont);
        var form = jQuery('.chat-form', cont);
        var input = jQuery('input', form);
        var btn = jQuery('.btn', form);
        ...
        var handleClick = function () {
            ...
            input.val("");
            jQuery('.scroller', cont).slimScroll({
    ...
    var handleClockfaceTimePickers = function () {
        ...
        jQuery('#clockface_1').clockface();

        jQuery('#clockface_2').clockface({
            format: 'HH:mm',
            trigger: 'manual'
        });

        jQuery('#clockface_2_toggle-btn').click(function (e) {
            e.stopPropagation();
            jQuery('#clockface_2').clockface('toggle');
        });

        jQuery('#clockface_3').clockface({
            format: 'H:mm'
    ...
    var handleMainMenu = function () {
        jQuery('#sidebar .has-sub > a').click(function () {
            var last = jQuery('.has-sub.open', jQuery('#sidebar'));
    ...
    var handleDashboardCharts = function () {
        ...
        var plot = jQuery.plot(jQuery("#site_statistics"), [{
            data: pageviews,
            label: "Unique Visits"
        }, {
            data: visitors,
        ...
        jQuery("#site_statistics").bind("plothover", function (event, pos, item) {
        ...
        jQuery('#load_statistics_loading').hide();
        jQuery('#load_statistics_content').show();

        var updateInterval = 30;
        var plot = jQuery.plot(jQuery("#load_statistics"), [getRandomData()], options);
    ...
    var handleCharts = function () {
        ...
        function chart2() {
            ...
            var plot = jQuery.plot(jQuery("#chart_2"), [{
                data: pageviews,
                label: "Unique Visits"
            }, {
                data: visitors,
            ...
            var previousPoint = null;
            jQuery("#chart_2").bind("plothover", function (event, pos, item) {
                jQuery("#x").text(pos.x.toFixed(2));
                jQuery("#y").text(pos.y.toFixed(2));
        ...
        function chart3() {
            ...
            plot = jQuery.plot(jQuery("#chart_3"), [{
                data: sin,
                label: "sin(x) = -0.00"
            }, {
                data: cos,
            ...
            var legends = jQuery("#chart_3 .legendLabel");
            ...
            jQuery("#chart_3").bind("plothover", function (event, pos, item) {
                latestPosition = pos;
        ...
        function chart4() {
            ...
            var updateInterval = 30;
            var plot = jQuery.plot(jQuery("#chart_4"), [getRandomData()], options);
        ...
        function chart5() {
            ...
            function plotWithOptions() {
                jQuery.plot(jQuery("#chart_5"), [d1, d2, d3], {
                    series: {
                        stack: stack,
                        lines: {
                            show: lines,
        ...
        function graphs() {
            ...
            jQuery.plot(jQuery("#graph_1"), graphData, {
                series: {
                    pie: {
                        show: true,
                        radius: 1,
            ...
            jQuery.plot(jQuery("#graph_2"), graphData, {
                series: {
                    pie: {
                        show: true,
                        radius: 1,
            ...
            jQuery.plot(jQuery("#graph_3"), graphData, {
                series: {
                    pie: {
                        show: true
                    }
            ...
            jQuery("#graph_3").bind("plothover", pieHover);
            jQuery("#graph_3").bind("plotclick", pieClick);
            ...
            jQuery.plot(jQuery("#graph_4"), graphData, {
                series: {
                    pie: {
                        innerRadius: 0.5,
                        show: true
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            jQuery('#style_color').attr("href", "css/style_" + color + ".css");
        }
    ...
    var handlePeity = function () {
        ...
        jQuery(".stat.bad .line-chart").peity("line", {
            height: 20,
            width: 50,
            colour: "#d12610",
            strokeColour: "#666"
        ...
        jQuery(".stat.bad .bar-chart").peity("bar", {
            height: 20,
            width: 50,
            colour: "#d12610",
            strokeColour: "#666"
        ...
        jQuery(".stat.ok .line-chart").peity("line", {
            height: 20,
            width: 50,
            colour: "#37b7f3",
            strokeColour: "#757575"
        ...
        jQuery(".stat.ok .bar-chart").peity("bar", {
            height: 20,
            width: 50,
            colour: "#37b7f3"
        }).show();

        jQuery(".stat.good .line-chart").peity("line", {
            height: 20,
            width: 50,
            colour: "#52e136"
        }).show();

        jQuery(".stat.good .bar-chart").peity("bar", {
            height: 20,
            width: 50,
            colour: "#52e136"
        }).show();
        ...
        jQuery(".stat.bad.huge .line-chart").peity("line", {
            height: 20,
            width: 40,
            colour: "#d12610",
            strokeColour: "#666"
        ...
        jQuery(".stat.bad.huge .bar-chart").peity("bar", {
            height: 20,
            width: 40,
            colour: "#d12610",
            strokeColour: "#666"
        ...
        jQuery(".stat.ok.huge .line-chart").peity("line", {
            height: 20,
            width: 40,
            colour: "#37b7f3",
            strokeColour: "#757575"
        ...
        jQuery(".stat.ok.huge .bar-chart").peity("bar", {
            height: 20,
            width: 40,
            colour: "#37b7f3"
        }).show();

        jQuery(".stat.good.huge .line-chart").peity("line", {
            height: 20,
            width: 40,
            colour: "#52e136"
        }).show();

        jQuery(".stat.good.huge .bar-chart").peity("bar", {
            height: 20,
            width: 40,
            colour: "#52e136"
        }).show();
        ...
        jQuery(window).resize(function () {
            if (running == false) {
                ...
                setTimeout(function () {
                    ...
                    jQuery('#event_priority_chzn').width(jQuery('#event_title').width() + 15);
                    jQuery('#event_priority_chzn .chzn-drop').width(jQuery('#event_title').width() + 13);
    ...
    var handleGritterNotifications = function () {
        ...
        jQuery('#gritter-regular').click(function () {
        ...
        jQuery('#gritter-max').click(function () {
            ...
            jQuery.gritter.add({
                ...
                before_open: function () {
                    if (jQuery('.gritter-item-wrapper').length == 3) {
        ...
        jQuery('#gritter-without-image').click(function () {
            jQuery.gritter.add({
                // (string | mandatory) the heading of the notification
        ...
        jQuery('#gritter-light').click(function () {

            jQuery.gritter.add({
                // (string | mandatory) the heading of the notification
                title: 'This is a light notification',
                // (string | mandatory) the text inside the notification
                text: 'Just add a "gritter-light" class_name to your jQuery.gritter.add or globally to jQuery.gritter.options.class_name',
    ...
    var handleUniform = function () {
        ...
        if (test = jQuery("input[type=checkbox]:not(.toggle), input[type=radio]:not(.toggle)")) {
            test.uniform();
        }
    }
    ...
    var handleToggleButtons = function () {
        ...
        jQuery('.info-toggle-button').toggleButtons({
            style: {
                enabled: "info",
                disabled: ""
            }
        });
        jQuery('.success-toggle-button').toggleButtons({
            style: {
                enabled: "success",
                disabled: "danger"
            }
        });
        jQuery('.warning-toggle-button').toggleButtons({
            style: {
                enabled: "warning",
                disabled: "success"
            }
        ...
        jQuery('.height-toggle-button').toggleButtons({
            height: 100,
            font: {
                'line-height': '100px',
                'font-size': '20px',
        ...
        jQuery('.not-animated-toggle-button').toggleButtons({
            animated: false
        });

        jQuery('.transition-value-toggle-button').toggleButtons({
    ...
    var handleDateTimePickers = function () {
        ...
        function (start, end) {
            ...
            jQuery('#dashboard-report-range span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));

        });

        jQuery('#dashboard-report-range span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));

        jQuery('#form-date-range').daterangepicker({
            ranges: {
                'Today': ['today', 'today'],
                'Yesterday': ['yesterday', 'yesterday'],
                'Last 7 Days': [Date.today().add({
        ...
        function (start, end) {
            jQuery('#form-date-range span').html(start.toString('MMMM d, yyyy') + ' - ' + end.toString('MMMM d, yyyy'));
        });

        jQuery('#form-date-range span').html(Date.today().add({
            days: -29
        }).toString('MMMM d, yyyy') + ' - ' + Date.today().toString('MMMM d, yyyy'));
    ...
    var handleFormWizards = function () {
        ...
        jQuery('#form_wizard_1').bootstrapWizard({
            ...
            onNext: function (tab, navigation, index) {
                ...
                var current = index + 1;
                // set wizard title
                jQuery('.step-title', jQuery('#form_wizard_1')).text('Step ' + (index + 1) + ' of ' + total);
                // set done steps
                jQuery('li', jQuery('#form_wizard_1')).removeClass("done");
                ...
                App.scrollTo(jQuery('.page-title'));
            },
            ...
            onTabShow: function (tab, navigation, index) {
                ...
                jQuery('#form_wizard_1').find('.bar').css({
                    width: jQuerypercent + '%'
                });
            }
        });
...
// Slider input js
// try{
//     jQuery("#Slider1").slider({ from: 5, to: 50, step: 2.5, round: 1, dimension: '&nbsp;jQuery', skin: "round_plastic" });
//     jQuery("#Slider2").slider({ from: 5000, to: 150000, heterogeneity: ['50/50000'], step: 1000, dimension: '&nbsp;jQuery', skin: "round_plastic" });
